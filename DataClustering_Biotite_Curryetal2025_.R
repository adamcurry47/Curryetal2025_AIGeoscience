...
## read in data
inputdata <- read.csv("CentralSanJuanMinChemCompilation_Biotite.csv")
...
data1 <- inputdata[,c("SiO2_wt","Al2O3_wt","FeO_wt","MgO_wt","MnO_wt","TiO2_wt","K2O_wt","Na2O_wt","Eruption")]  ## makes sure the names exactly math those in your column headers
...
elements<- c("SiO2_wt","Al2O3_wt","FeO_wt","MgO_wt","MnO_wt","TiO2_wt","K2O_wt","Na2O_wt") ## makes sure the names exactly math those in your column headers
...
##normalize
data1_norm<- as.data.frame(lapply(data1_ilr[,c("V1","V2","V3","V4","V5","V6","V7")], normalise)) ##the number of vectors here is 1 less than the number of elements chosen above
...
write.csv(x = data1_fin, file = "biot_medianSD_4clust_forRandTrees.csv")
...
write.csv(x = data1_clusters, file = "biot_medianSD_4clust_forRandTrees_wClusters.csv")
...
par(mfrow=c(1,1))
pie(c(Cl1_perc,Cl2_perc,Cl3_perc,Cl4_perc),labels = c("C1 - 38%","C2 - 20%","C3 - 37%","C4 - 5%"), 
    col=c("black","red","green","blue"),main="Biot Clusters - All")
...
pie(c(SM1,SM2,SM3,SM4),labels = c("SM1-100","SM2-0","SM3-0","SM4-0"), 
    col=c("black","red","green","blue"),main="Biot Clusters - SM")
...
pie(c(NM1,NM2,NM3,NM4),labels = c("NM1-0","NM2-100","NM3-0","NM4-0"), 
    col=c("black","red","green","blue"),main="Biot Clusters - NM")
...
pie(c(CC1,CC2,CC3,CC4),labels = c("CC1-1","CC2-0","CC3-99","CC4-0"), 
    col=c("black","red","green","blue"),main="Biot Clusters - CC")
...
pie(c(RC1,RC2,RC3,RC4),labels = c("RC1-0","RC2-0","RC3-41","RC4-59"), 
    col=c("black","red","green","blue"),main="Biot Clusters - RC")
