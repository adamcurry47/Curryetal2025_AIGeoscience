...
## read in data
inputdata <- read.csv("CentralSanJuanMinChemCompilation_Hornblende.csv")
...
data1 <- inputdata[,c("SiO2_wt","Al2O3_wt","FeO_wt","MgO_wt","MnO_wt","TiO2_wt","K2O_wt","CaO_wt","Na2O_wt","Eruption")]  ## makes sure the names exactly math those in your column headers
...
elements<- c("SiO2_wt","Al2O3_wt","FeO_wt","MgO_wt","MnO_wt","TiO2_wt","K2O_wt","CaO_wt","Na2O_wt") ## makes sure the names exactly math those in your column headers
...
##normalize
data1_norm<- as.data.frame(lapply(data1_ilr[,c("V1","V2","V3","V4","V5","V6","V7","V8")], normalise)) ##the number of vectors here is 1 less than the number of elements chosen above
...
write.csv(x = data1_fin, file = "hbl_medianSD_4clust_forRandTrees.csv")
...
write.csv(x = data1_clusters, file = "hbl_medianSD_4clust_forRandTrees_wClusters.csv")
...
par(mfrow=c(1,1))
pie(c(Cl1_perc,Cl2_perc,Cl3_perc,Cl4_perc),labels = c("C1 - 48%","C2 - 14%","C3 - 20%","C4 - 18%"), 
    col=c("black","red","green","blue"),main="Hbl Clusters - All")
...
pie(c(SM1,SM2,SM3,SM4),labels = c("SM1-37","SM2-49","SM3-14","SM4 - 0%"), 
    col=c("black","red","green","blue"),main="Hbl Clusters - SM")
...
pie(c(NM1,NM2,NM3,NM4),labels = c("NM1-66","NM2-0","NM3-0","NM4 - 34%"), 
    col=c("black","red","green","blue"),main="Hbl Clusters - NM")
...
pie(c(CC1,CC2,CC3,CC4),labels = c("CC1-64","CC2-0","CC3-32","CC4 - 4%"), 
    col=c("black","red","green","blue"),main="Hbl Clusters - CC")
...
pie(c(RC1,RC2,RC3,RC4),labels = c("RC1-0","RC2-0","RC3-0","RC4 - 100%"), 
    col=c("black","red","green","blue"),main="Hbl Clusters - RC")
