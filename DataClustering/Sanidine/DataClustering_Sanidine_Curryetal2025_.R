...
## read in data
inputdata <- read.csv("CentralSanJuanMinChemCompilation_Sanidine.csv")
...
data1 <- inputdata[,c("Na2O_wt","SiO2_wt","CaO_wt", "K2O_wt","Al2O3_wt","BaO_wt", "Eruption")]  ## makes sure the names exactly math those in your column headers
...
elements<- c("Na2O_wt","SiO2_wt","CaO_wt", "K2O_wt","Al2O3_wt","BaO_wt") ## makes sure the names exactly math those in your column headers
...
write.csv(x = data1_fin, file = "san_medianSD_5clust_forRandTrees.csv")
...
write.csv(x = data1_clusters, file = "san_medianSD_5clust_forRandTrees_wClusters.csv")
...
par(mfrow=c(1,1))
pie(c(Cl1_perc,Cl2_perc,Cl3_perc,Cl4_perc,Cl5_perc),labels = c("C1 - 38%","C2 - 13%","C3 - 6%","C4 - 10%","C5 - 33%"), 
    col=c("black","red","green","blue","gray"),main="San Clusters - All")
...
pie(c(SM1,SM2,SM3,SM4,SM5),labels = c("SM1-2","SM2-8","SM3-1","SM4-0","SM5-89"), 
    col=c("black","red","green","blue","gray"),main="San Clusters - SM")
...
pie(c(NM1,NM2,NM3,NM4,NM5),labels = c("NM1-49","NM2-16","NM3-2","NM4-23","NM5-10"), 
    col=c("black","red","green","blue","gray"),main="San Clusters - NM")
...
pie(c(RC1,RC2,RC3,RC4,RC5),labels = c("RC1-64","RC2-13","RC3-23","RC4-0","RC5-0"), 
    col=c("black","red","green","blue","gray"),main="San Clusters - RC")
